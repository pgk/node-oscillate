...
OSCMessage.decode = function (byteArray) {
    return (new convert.Decoder()).decode(byteArray);
};


OSCMessage.encode = function () {
    var msg = OSCMessage.create.apply(null, arguments);
    return new buffer.Buffer(msg.toBinary(), 'binary');
};


OSCMessage.prototype.append = function (arg, typehint) {
	var binary, tag;
...
OSCMessage.prototype.toBinary = function () {
...
OSCBundle.prototype.append = function (arg, typehint) {
    var binary, blob;
...
OSCBundle.prototype.toBinary = function () {
...
module.exports.OSCBundle = OSCBundle;
module.exports.FromOSC = FromOSC;
module.exports.ToOSC = ToOSC;
